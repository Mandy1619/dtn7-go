...
type listenerTomlConfig struct {
	...
	PeerID  string	`toml:"peer_id"`	//PeerID is the DTN endpoint ID of the peer node. Used by the CLA to register the peer with DTN7's routing engine. Example: "dtn://node2/"
}
